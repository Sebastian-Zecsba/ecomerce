...
<div class="contenedor" style="max-width: 400px; margin-top: 50px;">
    ...
    <form action="actions/auth/register.php" method="POST">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="nombre" require_onced placeholder="Tu nombre" style="width: 100%; padding: 8px;">
        </div>

        <div style="margin-bottom: 15px;">
            <label>Email:</label>
            <input type="email" name="email" require_onced placeholder="ejemplo@correo.com" style="width: 100%; padding: 8px;">
        </div>

        <div style="margin-bottom: 15px;">
            <label>Contraseña:</label>
            <input type="password" name="password" require_onced minlength="6" placeholder="Mínimo 6 caracteres" style="width: 100%; padding: 8px;">
        </div>
